...
The **Collection** row keeps these options on one line and wraps only when the panel is too narrow:

| Control                       | Default and effect                                                                                                                           |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Analytics every N min         | 15 minutes; choose 5–120 in steps of five. This clock is separate from provider quota polling and appears when applicable.                   |
