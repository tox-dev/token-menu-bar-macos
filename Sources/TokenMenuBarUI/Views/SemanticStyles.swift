...
private struct UsageValueAppearanceKey: EnvironmentKey {
  static let defaultValue = UsageValueAppearance.current
}

extension EnvironmentValues {
  var usageValueAppearance: UsageValueAppearance {
    get { self[UsageValueAppearanceKey.self] }
    set { self[UsageValueAppearanceKey.self] = newValue }
  }
}
