...
@MainActor
private final class PopoverTabControl: NSSegmentedControl {
  override func viewDidMoveToWindow() {
    super.viewDidMoveToWindow()
    // AppKit otherwise scans the cached SwiftUI tabs for initial focus before showing the popover.
