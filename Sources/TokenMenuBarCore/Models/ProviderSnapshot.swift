...
public struct ProviderIdentity: Codable, Sendable, Hashable {
  ...
  var accountFingerprint: String? {
    ...
    return SHA256.hash(data: Data("\(email.lowercased())|\(organization ?? "")".utf8))
...
public struct CreditBalance: Codable, Sendable, Hashable {
  ...
  public init(
    ...
    self.hasCredits = hasCredits ?? (unlimited ? true : balance.map { $0 > 0 })
...
public struct SpendControl: Codable, Sendable, Hashable {
  ...
  public let creditAllowance: CreditAllowance?
  ...
  public init(
    ...
    creditAllowance: CreditAllowance? = nil
  ) {
    ...
    self.creditAllowance = creditAllowance
  }
}

public struct CreditAllowance: Codable, Sendable, Hashable {
  public let used: Decimal?
  public let limit: Decimal?
  public let remaining: Decimal?
  public let source: String?

  public init(used: Decimal?, limit: Decimal?, remaining: Decimal?, source: String? = nil) {
    self.used = used
    self.limit = limit
  ...
  public static func formatted(_ value: Decimal) -> String {
    "\(value.formatted(.number.precision(.fractionLength(0...6)))) credits"
  }
}

public struct ProviderDetail: Codable, Sendable, Hashable, Identifiable {
  public let id: String
  public let title: String
  public let value: String
  public let explanation: String

  public init(id: String, title: String, value: String, explanation: String) {
    self.id = id
    self.title = title
    self.value = value
...
public struct ResetCreditExpiry: Codable, Sendable, Hashable, Identifiable {
  public let id: String
...
public struct ResetCredits: Codable, Sendable, Hashable {
  ...
  public let expiries: [ResetCreditExpiry]
  public let details: [ProviderDetail]?

  public init(
    available: Int, applicable: Int, totalEarned: Int? = nil, immediatePurchaseEligible: Bool = false,
    expiries: [ResetCreditExpiry] = [], details: [ProviderDetail]? = nil
  ) {
  ...
  // Snapshots cached before expiries existed still have to load.
  public init(from decoder: any Decoder) throws {
    ...
    immediatePurchaseEligible = try container.decode(Bool.self, forKey: .immediatePurchaseEligible)
    expiries = try container.decodeIfPresent([ResetCreditExpiry].self, forKey: .expiries) ?? []
    details = try container.decodeIfPresent([ProviderDetail].self, forKey: .details)
  }
}
...
public struct ProviderSnapshot: Codable, Sendable, Hashable {
  ...
  public init(
    ...
    self.accountFingerprint = accountFingerprint ?? identity?.accountFingerprint
  }
