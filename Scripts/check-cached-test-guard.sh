...
if ! grep -Fq 'Native AppKit tests require an isolated GitHub-hosted desktop' "$guard_directory/output"; then
...
if grep -Fq '◇ Test run started.' "$guard_directory/output"; then
