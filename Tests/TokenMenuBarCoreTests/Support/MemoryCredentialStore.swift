...
extension MemoryCredentialStore: AntigravityAuthStore where Value == AntigravityAuth {
  func load() throws -> AntigravityAuth? { try read() }
}
...
typealias MemoryAntigravityStore = MemoryCredentialStore<AntigravityAuth>
